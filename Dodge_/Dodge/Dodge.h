...
#ifndef EAE6320_Dodge_H
#define EAE6320_Dodge_H
...
namespace eae6320
{
	class Dodge final : public Application::iApplication
	{
	...
	private:
		...
		const char* GetMainWindowClassName() const final { return "Theo's stuff Example Main Window Class"; }
